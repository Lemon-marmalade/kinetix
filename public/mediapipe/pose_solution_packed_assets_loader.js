...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      if (Module.__movementCoachPackedAssetsInitialized) return;
      if (!Module['FS_createPreloadedFile'] || !Module['FS_createPath'] ||
          !Module['addRunDependency'] || !Module['removeRunDependency']) {
        if (!Module['preRun']) Module['preRun'] = [];
        Module['preRun'].push(runWithFS);
        return;
      }

      Module.__movementCoachPackedAssetsInitialized = true;
